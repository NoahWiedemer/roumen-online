...
export const NPCS = [
  ...
  { id: 'smith', spot: 4, rot: 3.1, name: 'Garrick', title: 'Blacksmith', look: 'smith', roles: ['shop', 'quest'],
    shop: ['sword_wood', 'sword_bronze', 'sword_iron', 'greatsword_flame', 'ring_copper'],
  ...
  { id: 'armorer', spot: 3, rot: 0, name: 'Helga', title: 'Armor Merchant', look: 'armorer', roles: ['shop'],
    shop: ['armor_cloth', 'armor_leather', 'armor_plate', 'helm_leather', 'helm_iron', 'pants_leather', 'pants_plate', 'boots_leather', 'boots_plate', 'gloves_leather', 'gloves_plate'],
